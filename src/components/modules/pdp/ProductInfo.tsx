      ...
      <div>
        ...
        <div className="mt-3">
          {reviews.length > 0 ? (
            ...
            <a
              href="#customer-reviews"
              className="inline-flex items-center gap-2 text-xs text-botanical-700 hover:underline group cursor-pointer font-medium"
            >
              <div className="flex text-neutral-300">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star
                    key={star}
                    className="w-3.5 h-3.5 fill-transparent text-neutral-300"
                  />
                ))}
              </div>
